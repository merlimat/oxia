...
func (m *NewTermRequest) CloneVT() *NewTermRequest {
	...
	r.TargetHashRange = m.TargetHashRange.CloneVT()
...
func (this *NewTermRequest) EqualVT(that *NewTermRequest) bool {
	...
	if !this.TargetHashRange.EqualVT(that.TargetHashRange) {
		return false
	}
...
func (m *NewTermRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.TargetHashRange != nil {
		size, err := m.TargetHashRange.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *NewTermRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TargetHashRange", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.TargetHashRange == nil {
				m.TargetHashRange = &Int32HashRange{}
			}
			if err := m.TargetHashRange.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
...
func (m *NewTermRequest) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			if err := m.TargetHashRange.UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
